...
| [Tool architecture](architecture/tool-architecture.md) | Phase 3 execution boundary; 3.1–3.5 persistence, registry, permission evaluator, request lifecycle, and Approval integration implemented. Adapters/coordinator not. |
...
| [ADR-006](decisions/ADR-006-permission-and-approval-boundaries.md) | Tools + permission ceiling + approvals (3.3 evaluator; 3.4–3.5 consume it; policy not) |
...
| [ADR-008](decisions/ADR-008-controlled-tool-execution-boundary.md) | Actors execute only through registered tools (3.1–3.5 persistence, registry, permission, request lifecycle, Approval integration; adapters not implemented) |
...
| [Phase 3 — Tools + Permissions](phases/phase-03-tools-permissions.md) | Controlled execution boundary. In progress; 3.1–3.5 implemented. |
