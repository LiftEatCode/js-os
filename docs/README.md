...
| [Tool architecture](architecture/tool-architecture.md) | Phase 3 execution boundary; 3.1 persistence implemented, runtime not. |
...
| [Phase 3 — Tools + Permissions](phases/phase-03-tools-permissions.md) | Controlled execution boundary. In progress; 3.1 implemented. |
