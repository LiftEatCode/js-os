...
| [Command Center](architecture/command-center.md) | Internal operating UI: routes, navigation, Goals, Work, Activity, Approvals, implemented vs planned. |
...
| [Phase 2 — Command Center](phases/phase-02-command-center.md) | Shell, Overview, Goals, Work, Activity, and Approvals; later screens planned. |
