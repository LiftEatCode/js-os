...
| [ADR-006](ADR-006-permission-and-approval-boundaries.md) | Tools + permission ceiling + approvals (3.3 technical evaluator; 3.4–3.5 consume it; policy not) |
| [ADR-007](ADR-007-atomic-business-mutation-and-event-recording.md) | Atomic command boundary for state + BusinessEvent |
| [ADR-008](ADR-008-controlled-tool-execution-boundary.md) | Actors execute only through registered tools (3.1–3.5 persistence, registry, permission evaluator, request lifecycle, Approval integration; adapters not implemented) |
