#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/b7e2e049d3143bc89fda1ddbd6c962d379ee46c8dd83102436c78f46e67863a7/contract';
import endContract from '../../snapshots/b7e2e049d3143bc89fda1ddbd6c962d379ee46c8dd83102436c78f46e67863a7/contract.json' with { type: 'json' };
import {
  Migration,
  MigrationCLI,
  checkExpression,
  ...
  override get operations() {
    return [
      ...
      this.addUnique({
        schema: 'public',
        table: 'businessEvent',
        constraint: 'businessEvent_organizationId_sourceType_sourceId_key',
        columns: ['organizationId', 'sourceType', 'sourceId'],
      }),
      this.addUnique({
        schema: 'public',
        table: 'organization',
