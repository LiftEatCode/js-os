...
export type StorageHash =
  StorageHashBase<'b7e2e049d3143bc89fda1ddbd6c962d379ee46c8dd83102436c78f46e67863a7'>;
export type ExecutionHash =
  ExecutionHashBase<'d2f06e2f8d012f574c98b36d54aa3f0551b2c7a5d95d7b63c3b2974b0c57bc6b'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly ToolExecution: {
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly organizationId: CodecTypes['pg/uuid@1']['output'];
      readonly toolRequestId: CodecTypes['pg/uuid@1']['output'];
    ...
    readonly ToolRequest: {
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly organizationId: CodecTypes['pg/uuid@1']['output'];
      readonly toolSlug: CodecTypes['pg/text@1']['output'];
      readonly toolName: CodecTypes['pg/text@1']['output'];
      readonly toolVersion: CodecTypes['pg/int4@1']['output'];
      readonly requiredPermission: 'OBSERVE' | 'RECOMMEND' | 'PREPARE' | 'EXECUTE';
      readonly riskLevel: 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL';
      readonly approvalRequirement: 'NEVER' | 'ALWAYS';
      readonly status:
        | 'REQUESTED'
        | 'WAITING_APPROVAL'
        | 'READY'
      ...
      readonly requestedByType: 'USER' | 'AGENT' | 'SYSTEM';
      readonly requestedById: CodecTypes['pg/text@1']['output'] | null;
      readonly agentDefinitionId: CodecTypes['pg/uuid@1']['output'] | null;
      readonly agentRunId: CodecTypes['pg/uuid@1']['output'] | null;
      readonly workItemId: CodecTypes['pg/uuid@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly ToolExecution: {
      readonly id: CodecTypes['pg/uuid@1']['input'];
      readonly organizationId: CodecTypes['pg/uuid@1']['input'];
      readonly toolRequestId: CodecTypes['pg/uuid@1']['input'];
    ...
    readonly ToolRequest: {
      readonly id: CodecTypes['pg/uuid@1']['input'];
      readonly organizationId: CodecTypes['pg/uuid@1']['input'];
      readonly toolSlug: CodecTypes['pg/text@1']['input'];
      readonly toolName: CodecTypes['pg/text@1']['input'];
      readonly toolVersion: CodecTypes['pg/int4@1']['input'];
      readonly requiredPermission: 'OBSERVE' | 'RECOMMEND' | 'PREPARE' | 'EXECUTE';
      readonly riskLevel: 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL';
      readonly approvalRequirement: 'NEVER' | 'ALWAYS';
      readonly status:
      ...
      readonly requestedByType: 'USER' | 'AGENT' | 'SYSTEM';
      readonly requestedById: CodecTypes['pg/text@1']['input'] | null;
      readonly agentDefinitionId: CodecTypes['pg/uuid@1']['input'] | null;
      readonly agentRunId: CodecTypes['pg/uuid@1']['input'] | null;
      readonly workItemId: CodecTypes['pg/uuid@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly businessEvent: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['organizationId', 'sourceType', 'sourceId'] },
              ];
              indexes: readonly [
                {
            ...
            readonly toolExecution: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['toolRequestId', 'attemptNumber'] }];
              indexes: readonly [
                {
                  readonly name: 'toolExecution_organizationId_status_idx_21af5e82';
                  readonly prefix: 'toolExecution_organizationId_status_idx';
                  readonly columns: readonly ['organizationId', 'status'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolExecution_organizationId_createdAt_idx_c52d1cc3';
                  readonly prefix: 'toolExecution_organizationId_createdAt_idx';
                  readonly columns: readonly ['organizationId', 'createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolExecution_organizationId_idx_2e17ef41';
                  readonly prefix: 'toolExecution_organizationId_idx';
                  readonly columns: readonly ['organizationId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolExecution_toolRequestId_idx_8258479f';
                  readonly prefix: 'toolExecution_toolRequestId_idx';
                  readonly columns: readonly ['toolRequestId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'toolExecution';
                    readonly columns: readonly ['organizationId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                ...
                },
                {
                  ...
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'toolRequest';
                    readonly columns: readonly ['id'];
                  };
                },
              ];
            ...
            readonly toolRequest: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['organizationId', 'toolSlug', 'idempotencyKey'] },
              ];
              indexes: readonly [
                {
                  readonly name: 'toolRequest_organizationId_status_requestedAt_idx_9c16cf28';
                  readonly prefix: 'toolRequest_organizationId_status_requestedAt_idx';
                  readonly columns: readonly ['organizationId', 'status', 'requestedAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolRequest_organizationId_toolSlug_requestedAt_idx_9d4efc96';
                  readonly prefix: 'toolRequest_organizationId_toolSlug_requestedAt_idx';
                  readonly columns: readonly ['organizationId', 'toolSlug', 'requestedAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolRequest_agentDefinitionId_idx_3b61897d';
                  readonly prefix: 'toolRequest_agentDefinitionId_idx';
                  readonly columns: readonly ['agentDefinitionId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolRequest_agentRunId_idx_1f80425e';
                  readonly prefix: 'toolRequest_agentRunId_idx';
                  readonly columns: readonly ['agentRunId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolRequest_workItemId_idx_2fd4a055';
                  readonly prefix: 'toolRequest_workItemId_idx';
                  readonly columns: readonly ['workItemId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolRequest_approvalId_idx_23d09a03';
                  readonly prefix: 'toolRequest_approvalId_idx';
                  readonly columns: readonly ['approvalId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'toolRequest_organizationId_idx_2e17ef41';
                  readonly prefix: 'toolRequest_organizationId_idx';
                  readonly columns: readonly ['organizationId'];
                  readonly unique: false;
                },
              ];
          ...
          readonly valueSet: {
            ...
            readonly ToolActorType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['USER', 'AGENT', 'SYSTEM'];
            };
            readonly ToolApprovalRequirement: {
              readonly kind: 'valueSet';
              readonly values: readonly ['NEVER', 'ALWAYS'];
            };
            readonly ToolExecutionStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['QUEUED', 'RUNNING', 'SUCCEEDED', 'FAILED', 'CANCELLED'];
            };
            readonly ToolRequestStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly [
                'REQUESTED',
                'WAITING_APPROVAL',
            ...
            readonly ToolRequiredPermission: {
              readonly kind: 'valueSet';
              readonly values: readonly ['OBSERVE', 'RECOMMEND', 'PREPARE', 'EXECUTE'];
            };
            readonly ToolRiskLevel: {
              readonly kind: 'valueSet';
              readonly values: readonly ['LOW', 'MEDIUM', 'HIGH', 'CRITICAL'];
            };
...
> & {
  ...
  readonly roots: {
    ...
    readonly toolRequest: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ToolRequest';
    };
    readonly toolExecution: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ToolExecution';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
          ...
          readonly ToolExecution: {
            ...
            readonly relations: {
              ...
              readonly toolRequest: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['toolRequestId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'toolExecution';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly organizationId: { readonly column: 'organizationId' };
                readonly toolRequestId: { readonly column: 'toolRequestId' };
          ...
          readonly ToolRequest: {
            ...
            readonly relations: {
              ...
              readonly executions: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['toolRequestId'];
                };
              };
              readonly organization: {
                readonly to: {
            ...
            readonly storage: {
              readonly table: 'toolRequest';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly organizationId: { readonly column: 'organizationId' };
                readonly toolSlug: { readonly column: 'toolSlug' };
                readonly toolName: { readonly column: 'toolName' };
                readonly toolVersion: { readonly column: 'toolVersion' };
                readonly requiredPermission: { readonly column: 'requiredPermission' };
                readonly riskLevel: { readonly column: 'riskLevel' };
                readonly approvalRequirement: { readonly column: 'approvalRequirement' };
                readonly status: { readonly column: 'status' };
                ...
                readonly agentRunId: { readonly column: 'agentRunId' };
                readonly workItemId: { readonly column: 'workItemId' };
                readonly approvalId: { readonly column: 'approvalId' };
        ...
        readonly enum: {
          ...
          readonly ToolApprovalRequirement: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'NEVER'; readonly value: 'NEVER' },
